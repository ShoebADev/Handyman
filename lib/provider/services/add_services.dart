...
class _AddServicesState extends State<AddServices> {
  ...
  List<VisitTypeData> visitTypeData = [
    ...
    VisitTypeData(isEnabled: false, title: languages.onlineRemoteService, key: VISIT_OPTION_ONLINE),
  ];
              ...
              children: [
                ...
                AppTextField(
                  ...
                  validator: (s) {
                    ...
                    if (s.toDouble().isNegative || s.toInt() > 99) return '${discountCont.text}% ${languages.isNotValid}';
                    return null;
                  },
                ).expand(),
              ],
