...
Future<ConfigurationResponse> configurationDashboard() async {
  ...
  if (data.otherSettings != null) {
    ...
    compareValuesInSharedPreference(FORCE_UPDATE_PROVIDER_APP, otherSetting.forceUpdateProviderApp);
    compareValuesInSharedPreference(PROVIDER_APP_MINIMUM_VERSION, otherSetting.providerAppMinimumVersion);
    compareValuesInSharedPreference(PROVIDER_APP_LATEST_VERSION, otherSetting.providerAppLatestVersion);
  ...
  if (isOneSignalInitialize == false) {
    initializeOneSignal();
  }
